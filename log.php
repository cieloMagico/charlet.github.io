<?php
include("verificarUsuarioyPass.php");
?>
<!doctype html>
                                    ...
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">Categorias</a>
                                                <ul class="submenu">
                                                    <li><a href="product_list.html"> MDF</a></li>
                                                    <li><a href="single-product.html"> Grabados</a></li>
                                                    <li><a href="single-product.html"> Robotica</a></li>
                                                    <li><a href="single-product.html"> Diseños</a></li>
                                                </ul>
                                            </li>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <p>Aqui encontraras los mejores productos a tu disposicion
                               consigue ofertas exclusivas y solo basta con 
                            </p>
                    ...
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>Bienvenido de vuelta <br>
                                ingresa tus datos de inicio de sesion</h3>
                            <form class="row contact_form" action="verificarUsuarioyPass.php" method="post" novalidate="novalidate">
